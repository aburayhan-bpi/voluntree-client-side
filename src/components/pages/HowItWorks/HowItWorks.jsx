        ...
        <div class="w-full flex-col justify-start items-center lg:gap-12 gap-10 inline-flex">
          <div class="w-full flex-col justify-start items-center gap-3 flex">
            ...
            <p class="w-full text-center text-gray-500 text-base font-normal leading-relaxed">
              Voluntree is a volunteer management system that allows users to create accounts, post volunteer needs,
              manage their posts, and much more. Here’s how it works:
            </p>
          </div>
          <div class="w-full justify-start items-center gap-4 flex md:flex-row flex-col">
            <div class="grow shrink basis-0 flex-col justify-start items-center gap-2.5 inline-flex">
              ...
              <p class="self-stretch text-center text-gray-400 text-base font-normal leading-relaxed">
                Start by creating an account on Voluntree. Whether you're an individual looking to volunteer or an
                organization in need of volunteers, signing up is quick and easy.
              </p>
            </div>
            <svg
            ...
            <div class="grow shrink basis-0 flex-col justify-start items-center gap-2.5 inline-flex">
              ...
              <p class="self-stretch text-center text-gray-400 text-base font-normal leading-relaxed">
                After creating your account, post your volunteer needs on Voluntree. Whether you need volunteers for a
                specific project or ongoing help, you can easily manage your posts.
              </p>
            </div>
            <svg
              class="md:flex hidden"
            ...
            <div class="grow shrink basis-0 flex-col justify-start items-center gap-2.5 inline-flex">
              ...
              <p class="self-stretch text-center text-gray-400 text-base font-normal leading-relaxed">
                Once your posts are live, you can manage and track the volunteers who are interested in helping. You can
                easily connect with volunteers and handle requests directly through your account.
              </p>
            </div>
          </div>
        </div>
